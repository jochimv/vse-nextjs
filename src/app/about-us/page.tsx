      ...
      <Container maxWidth="lg">
        <Box sx={{ my: 4 }}>
          ...
          <Typography variant="h6" gutterBottom>
            Welcome to our Car Dealership! We are dedicated to providing you
            with the best service and the best cars.
          </Typography>
          <Divider sx={{ my: 3 }} />
              ...
              <Card>
                <CardContent>
                  ...
                  <Typography variant="body1" gutterBottom>
                    ...
                    Our team is committed to helping you find the perfect car
